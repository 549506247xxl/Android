...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void onDurationChanged(String input) {
        ...
        if (isValid) {
            ...
            duration = Integer.parseInt(durationSelector.getText().toString());
            resetTargetAnimation();
        } else {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2_X = ObjectAnimator.ofFloat(target,
                "scaleX",1f, 2f);
        animator2_X.setDuration(duration);
        animator2_X.setInterpolator(new LinearInterpolator()); //插入线性加速器
        ...
        ObjectAnimator animator2_Y = ObjectAnimator.ofFloat(target,
                "scaleY",1f, 2f);
        animator2_Y.setDuration(duration);
        animator2_Y.setInterpolator(new LinearInterpolator()); //插入线性加速器
